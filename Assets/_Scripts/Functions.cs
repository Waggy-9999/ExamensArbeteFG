...
namespace Utility.Easing
{
    ...
    {
        public static float GetEaseValue(EasingType easingType, float T)
        {
            switch(easingType) 
            {
                case EasingType.SineIn: return Sine_In(T);
                case EasingType.SineOut: return Sine_Out(T);
                case EasingType.SineInOut: return Sine_InOut(T);
                case EasingType.QuadIn: return Quad_In(T);
                case EasingType.QuadOut: return Quad_Out(T);
                case EasingType.QuadInOut: return Quad_InOut(T);
                case EasingType.CubeIn: return Cubic_In(T);
                case EasingType.CubeOut: return Cubic_Out(T);
                case EasingType.CubeInOut: return Cubic_InOut(T);
                case EasingType.QuartIn: return Quart_In(T);
                case EasingType.QuartOut: return Quart_Out(T);
                case EasingType.QuartInOut: return Quart_InOut(T);
                case EasingType.QuintIn: return Quint_In(T);
                case EasingType.QuintOut: return Quint_Out(T);
                case EasingType.QuintInOut: return Quint_InOut(T);
                case EasingType.ExponentialIn: return Expo_In(T);
                case EasingType.ExponentialOut: return Expo_Out(T);
                case EasingType.ExponentialInOut: return Expo_InOut(T);
                case EasingType.CircularIn: return Circ_In(T);
                case EasingType.CircularOut: return Circ_Out(T);
                case EasingType.CircularInOut: return Circ_InOut(T);
                case EasingType.BackBounceIn: return Back_In(T);
                case EasingType.BackBounceOut: return Back_Out(T);
                case EasingType.BackBounceInOut: return Back_InOut(T);
                case EasingType.ElasticIn: return Elastic_In(T);
                case EasingType.ElasticOut: return Elastic_Out(T);
                case EasingType.ElasticInOut: return Elastic_InOut(T);
                case EasingType.BounceIn: return Bounce_In(T);
                case EasingType.BounceOut: return Bounce_Out(T);
                case EasingType.BounceInOut: return Bounce_InOut(T);
                default: return T;
            }
        }        
